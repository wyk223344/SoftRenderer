...
void DrawUtil::DrawLine(int x0, int y0, int x1, int y1, FrameBuffer *frameBuffer, Vector4 color) {
    bool steep = false;
...
void DrawUtil::DrawTriangle(Vector3 *pts, float *zBuffer, FrameBuffer *frameBuffer, Vector2 *uvs, Image *image, float intensity) {
